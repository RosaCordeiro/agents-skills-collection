...
| Pasta | Conteudo |
|-------|----------|
| [context/](context/) | Dominio, usuarios, stack, limites do sistema |
| [rules/](rules/) | Regras locais de desenvolvimento (convencoes do repo) |
| [decisions/](decisions/) | ADRs — decisoes arquiteturais fechadas |
